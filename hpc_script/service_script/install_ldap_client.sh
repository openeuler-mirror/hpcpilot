...
scp_to_remote_command ${ldap_master_ip} /root/ldap.crt /root/ldap.crt
ansible-playbook -e "ldap_server_ip=${ldap_domain} ldap_base_dc=${ldap_base_dc}" ${base_directory}/service_script/install_ldap_cli_TLS.yml
ansible-playbook -e "ldap_server_ip=${ldap_domain} ldap_login_password=${ldap_login_password} ldap_base_dc=${ldap_base_dc}" ${base_directory}/service_script/install_ldap_nslcd.yml
